...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	<head>
		<title>Visualise Stock Sales (Only Linked Editions)</title>
    ...
    <div id="selected" style="height:auto;padding:30px;">
		...
		<p style="line-height:30px;">
    		<h3 style="color:#800000;line-height:1.3em;text-align:center;">STOCK SALES<br />Only Linked Editions</h3>
...
/////////////////////////////////////////////////////////// Get All Edition Nodes and Connections	
	...
	$myQueryCheck = "SELECT DISTINCT(ID_EditionName), SUM(EventCopies), COUNT(DISTINCT(EventSaleReasonText)) ";
	$myQueryCheck .= "FROM manuscript_events_sales ";
	$myQueryCheck .= "WHERE EventType = \"Stock Sale\" ";
	$myQueryCheck .= "AND ID_EditionName != \"\" ";
	$myQueryCheck .= "GROUP BY ID_EditionName ";
	$myQueryCheck .= "ORDER BY ID_EditionName ASC ";
	$mysqli = new mysqli("$localhost", "$username", "$password", "$database");
	$result = $mysqli->query("$myQueryCheck");
	while ($row = mysqli_fetch_row($result)){
		if(($row[2] > 1)) {
